...
import { ssrRenderAttrs, ssrRenderStyle, ssrRenderList, ssrRenderComponent, ssrInterpolate, ssrRenderAttr, ssrRenderClass } from 'vue/server-renderer';
...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "inline-flex items-center gap-2 flex-shrink-0" }, _attrs))}><span class="text-lg">${ssrInterpolate(__props.icon)}</span><span class="text-sm font-medium" style="${ssrRenderStyle({ "color": "var(--text-muted)" })}">${ssrInterpolate(__props.label)}</span><span class="text-slate-400 mx-2">\xB7</span></div>`);
    };
  }
});
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const complianceItems = [
      { icon: "\u{1F1F0}\u{1F1EA}", label: "KRA PAYE Compliant" },
      { icon: "\u2705", label: "NSSF Tier I & II" },
      { icon: "\u{1F3E5}", label: "SHIF / NHIF" },
      { icon: "\u{1F3E0}", label: "Housing Levy (AHL)" },
      { icon: "\u{1F4CB}", label: "P9 Forms" },
      { icon: "\u{1F4BC}", label: "Multi-Company" },
      { icon: "\u{1F512}", label: "Data Secure" },
...
//# sourceMappingURL=index-D24KozAp.mjs.map
