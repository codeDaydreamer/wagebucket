...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CUbM4kib.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-B4_1W53d.mjs'));
...
export { _export_sfc as _, useNuxtApp as a, useRuntimeConfig as b, nuxtLinkDefaults as c, useHead as d, entry_default as default, encodeRoutePath as e, useSeoMeta as f, useState as g, navigateTo as n, resolveRouteObject as r, useRouter as u };
